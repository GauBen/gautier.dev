    ...
    <div class="column">
      <article>
        ...
        <div class="xp">
          ...
          <ul>
            <li>
              Architecture et développement de fonctionnalités dans le SaaS
            </li>
          </ul>
          <div class="stuff">
            <span class="tags">
        ...
        <div class="xp">
          ...
          <ul>
            <li>
              ...
              chiffrer et déchiffrer des emails à l’aide d’une clé sur une carte
              NFC
            </li>
            <li>
              Conception et développement d’un serveur de clés publiques PGP
            </li>
        ...
        <div class="xp">
          ...
          <ul>
            ...
            <li>
              Animation du live YouTube et du tournoi entre les 60 équipes
            </li>
          </ul>
          <div class="stuff">
            <span class="tags">
      ...
      <article>
        ...
        <div class="xp">
          <p>
            <strong>Master de Cybersécurité et Gouvernance (TLS-SEC)</strong>
          </p>
          <p>2022, Formation conjointe ENSEEIHT, INSA Toulouse et ENAC</p>
        </div>
        <div class="xp">
          <p>
            <strong>Master de Génie Logiciel et des Systèmes</strong>
          </p>
          <p>2019–2022, ENSEEIHT, Toulouse</p>
        </div>
        <div class="xp">
          <p>
            <strong>Classe préparatoire MPSI et MP*</strong>
          </p>
          <p>2017–2019, Lycée Saint-Louis, Paris</p>
        </div>
      </article>
    </div>
    <div class="column">
